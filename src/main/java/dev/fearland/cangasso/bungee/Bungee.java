package dev.fearland.cangasso.bungee;

import com.google.common.io.ByteArrayDataOutput;
import com.google.common.io.ByteStreams;
import dev.fearland.cangasso.bungee.cmd.Commands;
import dev.fearland.cangasso.bungee.listener.Listeners;
...
public class Bungee extends Plugin {
  ...
  public Bungee() {
    ...
    public static void teleport(ProxiedPlayer player, ProxiedPlayer target) {
    }
  ...
  private void setupRoles() {
    ...
    for (String key : roles.getSection("roles").getKeys()) {
      ...
      boolean broadcastplus = roles.getBoolean("roles." + key + ".broadcastplus", true);
