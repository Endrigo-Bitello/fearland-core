package dev.fearland.cangasso.player;

import dev.fearland.cangasso.game.Game;
import dev.fearland.cangasso.game.GameTeam;
import dev.fearland.cangasso.hook.FriendsHook;
import dev.fearland.cangasso.player.enums.PlayerVisibility;
import dev.fearland.cangasso.player.hotbar.Hotbar;
import dev.fearland.cangasso.player.role.Role;
import dev.fearland.cangasso.player.scoreboard.KScoreboard;
...
import dev.fearland.cangasso.database.data.container.*;
...
public class Profile {
    ...
    public int addSouls(String table, double amount) {
        this.getDataContainer(table, "souls").addDouble(amount);
        return (int) amount;
    }
    ...
    public void removeSouls(String table, double amount) {
        this.getDataContainer(table, "souls").removeDouble(amount);
    }
    ...
    public double getSouls(String table) {
        return this.getDataContainer(table, "souls").getAsDouble();
    }
