...
import dev.fearland.cangasso.libraries.profile.Mojang;
...
import dev.fearland.cangasso.reflection.acessors.MethodAccessor;
...
public class Manager {
  ...
  static {
    try {
      ...
      Class<?> bungeeMain = Class.forName("dev.fearland.cangasso.bungee.Bungee");
      ...
      try {
        ...
        Class<?> fakeManager = Class.forName("dev.fearland.cangasso.player.fake.FakeManager");
        GET_NAME = Accessors.getMethod(player, "getName");
        GET_PLAYER = Accessors.getMethod(Class.forName("dev.fearland.cangasso.player.Profile"), "findCached", String.class);
  ...
  public static String getSkin(String player, boolean value) {
    try {
      ...
      if (id != null) {
        ...
        if (textures != null) {
          return value ? textures.split(" : ")[1] : textures.split(" : ")[2];
        }
      }
